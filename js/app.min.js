...
$(window).on("load",function(){$('a.main-header__link[href*="#"], a.main-footer__link[href*="#"], .first a[href*="#"]').click(function(){let t=0;return t=(992<=$(window).width()?$(".main-header__menu"):$(".main-header")).outerHeight(),$("html, body").animate({scrollTop:$($.attr(this,"href")).offset().top-t-25},"slow","swing"),!1}),$(".to-top").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),$("html").on("submit",".form-application",function(t){t.preventDefault();t=$(this);$.ajax({url:"/form-application.php",type:"POST",data:t.serialize(),dataType:"html",success:function(t){$(".pop-up__close").trigger("click"),$("#accepted-hidden").trigger("click")}})}),$("html").on("submit",".form-calculator",function(t){t.preventDefault();t=$(this);$.ajax({url:"/form-calculator.php",type:"POST",data:t.serialize(),dataType:"html",success:function(t){$("#accepted-hidden").trigger("click")}})})});